...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Hỗ trợ Full HD (1920$\times$1080) với frame size 100-200 KB
    ...
    \begin{itemize}
        ...
        \item Smooth playback với constant frame rate 25 FPS
    \end{itemize}
\end{enumerate}
...
\hline
Max resolution supported & 1920$\times$1080 \\
Max frame size & 200 KB \\
Frame rate & 25 FPS \\
RTP packet size & $\leq$ 1400 bytes \\
